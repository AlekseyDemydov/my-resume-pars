...
let placeholder=''
  ...
  btnSendMe.addEventListener('click', (e) => {
    const conditionName = hash === 'en' ? 'enter your name' : 'введіть своє ім я';  
    placeName.placeholder = conditionName;
   
const conditionNumber = hash === 'en' ? 'enter your number' : 'введіть свій номер';  
    placeNumber.placeholder = conditionNumber;
    
    const conditionText = hash === 'en' ? 'enter your message' : 'введіть своє повідомлення';  
